...
/*Html code*/
define('REQ_FIELD','<i class="f-color-red">*</i>');

define('BUTTON_EDIT', '<button title="" data-toggle="tooltip" type="button" class="btn btn-xs btn-default" data-original-title="แก้ไข"><i class="ion-edit"></i></button>');
define('BUTTON_DELETE', '<button title="" data-toggle="tooltip" type="button" class="btn btn-xs btn-default" data-original-title="ลบ"><i class="ion-close"></i></button>');
...
define('SITE_URL', 'https://www.lovethaihome.com/');
