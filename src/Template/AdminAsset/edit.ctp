    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-block">
                ...
                <div class="form-group">
                    <div class="col-xs-12">
                        <label for="youtube_link">Link Youtube (***ถ้าไม่มีให้เว้นว่างไว้)</label>
                        <?= $this->Form->input('youtube_link', ['id'=>'youtube_link','class' => 'form-control', 'label' => false]); ?>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-xs-6">
                ...
                <div class="form-group">
                    <div class="col-xs-6">
                        <label for="example-nf-email">ประเภทสินทรัพย์ <?= REQ_FIELD ?></label>
                        <?= $this->Form->input('asset_type_id', ['options' => $assetTypes, 'empty' => false, 'class' => 'form-control', 'label' => false]); ?>
                    </div>
                    <div class="col-xs-6">
                        <label for="example-nf-email">โซน <?= REQ_FIELD ?></label>
                ...
                <div class="form-group">
                    <div class="col-xs-6 paddin-0">
                        <div class="col-xs-4">
                            ...
                            <?= $this->Form->input('price_amounnt', ['class' => 'form-control', 'label' => false, 'type' => 'number','step'=>'0.01']); ?>
                        </div>
                        <div class="col-xs-4">
                            <label for="">ราคาต่อตารางวา/บาท</label>
                            <?= $this->Form->input('price_per_wah', ['class' => 'form-control', 'label' => false,'type' => 'number','step'=>'0.01']); ?>
                        </div>
                        <div class="col-xs-4">
                            <label for="">ราคาให้เช่า/บาท</label>
                            <?= $this->Form->input('price_rent', ['class' => 'form-control', 'label' => false, 'type' => 'number','step'=>'0.01']); ?>
                        </div>
                        <div class="col-xs-6">
                        ...
                        <div class="col-xs-6">
                            ...
                            <?= $this->Form->input('price_amounnt_lower', ['class' => 'form-control', 'label' => false, 'type' => 'number','step'=>'0.01']); ?>
                        </div>
                ...
                <div class="form-group">
                    <div class="col-xs-3">
                        ...
                        <?= $this->Form->input('floor', ['class' => 'form-control', 'label' => false, 'type' => 'number','step'=>'0.01']); ?>
                    </div>
                    <div class="col-xs-3">
                        <label for="example-nf-email">จำนวนชั้น</label>
                        <?= $this->Form->input('floor_total', ['class' => 'form-control', 'label' => false, 'type' => 'number','step'=>'0.01']); ?>
                    </div>
                    <div class="col-xs-3">
                        <label for="example-nf-email">จำนวนห้องนอน</label>
                        <?= $this->Form->input('bedroom', ['class' => 'form-control', 'label' => false, 'type' => 'number','step'=>'0.01']); ?>
                    </div>
                    <div class="col-xs-3">
                        <label for="example-nf-email">จำนวนห้องน้ำ</label>
                        <?= $this->Form->input('bathroom', ['class' => 'form-control', 'label' => false, 'type' => 'number','step'=>'0.01']); ?>
                    </div>
                ...
                <div class="form-group">
                    <div class="col-xs-3">
                        ...
                        <?= $this->Form->input('kitchen_room', ['class' => 'form-control', 'label' => false, 'type' => 'number','step'=>'0.01']); ?>
                    </div>
                    <div class="col-xs-3">
                        <label for="example-nf-email">ห้องรับแขก</label>
                        <?= $this->Form->input('reception_room', ['class' => 'form-control', 'label' => false, 'type' => 'number','step'=>'0.01']); ?>
                    </div>
                    <div class="col-xs-3">
                        <label for="example-nf-email">ห้องทานอาหาร</label>
                        <?= $this->Form->input('dining_room', ['class' => 'form-control', 'label' => false, 'type' => 'number','step'=>'0.01']); ?>
                    </div>
                    <div class="col-xs-3">
                        <label for="example-nf-email">ห้องแม่บ้าน</label>
                        <?= $this->Form->input('maid_room', ['class' => 'form-control', 'label' => false, 'type' => 'number','step'=>'0.01']); ?>
                    </div>
                ...
                <div class="form-group">
                    <div class="col-xs-3">
                        ...
                        <?= $this->Form->input('parking', ['class' => 'form-control', 'label' => false, 'type' => 'number','step'=>'0.01']); ?>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-xs-3">
                        ...
                        <?= $this->Form->input('area_rai', ['class' => 'form-control', 'label' => false, 'type' => 'number','step'=>'0.01']); ?>
                    </div>
                    <div class="col-xs-3">
                        <label for="example-nf-email">พื้นที่/งาน</label>
                        <?= $this->Form->input('area_ngan', ['class' => 'form-control', 'label' => false,'type' => 'number','step'=>'0.01']); ?>
                    </div>
                    <div class="col-xs-3">
                        <label for="example-nf-email">พื้นที่/ตารางวา</label>
                        <?= $this->Form->input('area_wah', ['class' => 'form-control', 'label' => false, 'type' => 'number','step'=>'0.01']); ?>
                    </div>
                    <div class="col-xs-3">
                        <label for="example-nf-email">พื้นที่/ตารางเมตร</label>
                        <?= $this->Form->input('area_meter', ['class' => 'form-control', 'label' => false, 'type' => 'number','step'=>'0.01']); ?>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-xs-3">
                        <label for="">หน้ากว้าง/เมตร</label>
                        <?= $this->Form->input('area_width', ['class' => 'form-control', 'label' => false, 'type' => 'number','step'=>'0.01']); ?>
                    </div>
                    <div class="col-xs-3">
                        <label for="">ลึก/เมตร</label>
                        <?= $this->Form->input('area_long', ['class' => 'form-control', 'label' => false, 'type' => 'number','step'=>'0.01']); ?>
                    </div>
                    <div class="col-xs-3">
                        <label for=""></label>
                        <div class="checkbox">
